...
3. Customer names a specific rep who made a promise → escalate account management (partner). Don't process.
4. Verification absent/unverified + no SSO → escalate account management (unverified). Don't verify — escalate.
